...
public class UpdateEquipment extends JFrame implements ActionListener{
    ...
    UpdateEquipment(String eId) {
        ...
        try {
            Conn c = new Conn();
            String query = "select * from equipment where name = '"+EId+"'";
            ...
            while(rs.next()) {
                ...
                tfboughton.setText(rs.getString("date"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                Conn conn = new Conn();
                String query = "update equipment set name = '"+fname+"', cost = '"+fcost+"', quantity = '"+fquantity+"', company = '"+fcompany+"', date =  '"+fdate+"' where EId = '"+EId+"'";
