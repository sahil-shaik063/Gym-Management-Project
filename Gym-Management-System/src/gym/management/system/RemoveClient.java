...
public class RemoveClient extends JFrame implements ActionListener {
    ...
    RemoveClient() {
        ...
        try {
            Conn c = new Conn();
            String query = "select * from client where CId = '"+cEmpId.getSelectedItem()+"'";
            ResultSet rs = c.s.executeQuery(query);
            while(rs.next()) {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == delete) {
            try {
                Conn c = new Conn();
                String query = "delete from client where CId = '"+cEmpId.getSelectedItem()+"'";
